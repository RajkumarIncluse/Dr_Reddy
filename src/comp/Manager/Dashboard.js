        ...
        <div className='bg-white shadow-md rounded'>
          ...
          <div className='grid grid-cols-4 text-center'>
            <div className='border-r font-medium'>
              <p className='mt-4 text-sm'>Total missions</p>
            ...
            <div className='border-r font-medium'>
              <p className='mt-4 text-sm'>Ongoing missions</p>
            ...
            <div className='border-r font-medium'>
              <p className='mt-4 text-sm'>Ended missions</p>
            ...
            <div className='font-medium'>
              <p className='mt-4 text-sm'>IOT Devices</p>
      ...
      <div className='h-full col-span-2 p-1 pl-8 pb-4 pr-10 overflow-y-hidden'>
        <div className='dfc gap-0 h-[inherit] bg-white shadow-md rounded'>
          ...
          <div className='border-t pt-2'>
            <button className='dc mx-auto mb-2 bg-[#6e5bc5] text-white font-medium hover:scale-105 transition-transform'>
